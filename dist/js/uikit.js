...
function find(selector, context) {
    ...
    return $$1(_query(selector, context));
}
...
function remove(element) {
    toNodes(element).forEach(function (element) { return element.parentNode.removeChild(element); });
}
    ...
    methods: {
        ...
        show: function show() {
            ...
            if (this.container && this.$el.parentNode !== this.container) {
                ...
                return new Promise(function (resolve) { return requestAnimationFrame(function () { return resolve(this$1.show()); }
                    ); }
                )
            }
        ...
        _toggleImmediate: function _toggleImmediate(el, show) {
            ...
            return this.transitionDuration ? new Promise(function (resolve, reject) {

                if (this$1._transition) {
                    this$1._transition.unbind();
                    this$1._transition.reject();
                }

                this$1._transition = {
                    reject: reject,
                    unbind: once(this$1.transitionElement, transitionend, function () {
                        resolve();
...
function deregister(name) {
    events[name].forEach(function (unbind) { return unbind(); });
    delete events[name];
}
                ...
                handler: function handler() {
                    ...
                    target[isInput(target) ? 'value' : 'innerText'] = input.files && input.files[0]
                        ...
                        : matches(input, 'select') && input.hasChildNodes
                            ? $$('option', input).filter(function (el) { return el.selected; })[0].innerText
                            : input.value;
                }
            ...
            scrollTo: function scrollTo(el) {
                ...
                var start = Date.now(),
                    ...
                    step = function () {
                        var time = Date.now(),
                            currentY,
                            elapsed = (time - start) / this$1.duration;
...
var Svg = function (UIkit) {
    ...
    UIkit.component('svg', {
        ...
        connected: function connected() {
            ...
            this.svg = this.getSvg().then(function (svg) { return new Promise(function (resolve, reject) {
        ...
        disconnected: function disconnected() {
            ...
            if (this.svg) {
                this.svg.then(function (svg) { return remove(svg); }, noop);
                this.svg = null;
            }
        },
...
function plugin$2(UIkit) {
    ...
    UIkit.mixin.slideshow = {
        ...
        computed: {
            ...
            slides: function slides(ref) {
                var clsItem = ref.clsItem;

                return filter(this.list.children, ("." + clsItem));
            },

            forwardDuration: function forwardDuration(ref) {
        ...
        methods: {
            ...
            show: function show(index, force) {
                ...
                this._animation = new Transitioner(!prev ? 'scale' : this.animation, this.transition, prev || next, next, dir, function () {
                    ...
                    prev && removeClass(prev, this$1.clsActive);
                    ...
                    trigger(this$1.$el, 'itemshown', [this$1, next]);
                    UIkit.update(null, next);

                    if (prev) {
                        trigger(this$1.$el, 'itemhidden', [this$1, prev]);
            ...
            startAutoplay: function startAutoplay() {
                ...
                if (this.autoplay) {
                    this.interval = setInterval(function () { return !this$1.isHovering && this$1.show('next'); }, this.autoplay);
                }
...
function plugin$1(UIkit) {
    ...
    UIkit.component('lightbox-panel', {
        ...
        created: function created() {
            ...
            this.items.forEach(function (el, i) { return append(this$1.list, ("<li class=\"" + (this$1.clsItem) + " item-" + i + "\"></li>")); });
    ...
    function animate(el, animation, dir) {
        ...
        attr(el, 'hidden', null);
        Animation[dir](el, animation).then(function () { return dir === 'out' && attr(el, 'hidden', ''); });
    }
