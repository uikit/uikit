...
(function(addon) {
    ...
    UI.component('timepicker', {
        ...
        getCursorPosition: function() {
            ...
            if ('selectionStart' in this.domelement) {// Standard-compliant browsers
                ...
                sel.moveStart('character', - this.domelement.value.length);
        ...
        updateFromElementVal: function() {
            if (this.domelement.value) this.setTime(this.domelement.value);
        }
    });
