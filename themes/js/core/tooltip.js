(function($, UI) {
    ...
    UI.component('tooltip', {
        ...
        defaults: {
            ...
            "cls": "",
            //xxx "src": function() { return this.attr("title"); }
            "src": function() { return this.attr("data-cached-title"); }
        },
        ...
        boot: function() {
            ...
            UI.$html.on("mouseenter.tooltip.uikit focus.tooltip.uikit", "[data-@-tooltip]", function(e) {
                ...
                //console.log('boot', ele.length, ele);
                if (!ele.data("tooltip")) {
        ...
        init: function() {
            ...
            //xxx this.element.attr("data-cached-title", this.element.attr("title")).attr("title", "");
        ...
        show: function() {
            ...
            //xxx
            //todo т.к. реакт меняет данные динамически, то приходится каждый раз получать текст
            this.tip = this.element.attr("data-cached-title");
            //
