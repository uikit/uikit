...
!function(t,i){"use strict";function n(t){var n=i.$(t),a="auto";if(n.is(":visible"))a=n.outerHeight();else{var s={position:n.css("position"),visibility:n.css("visibility"),display:n.css("display")};a=n.css({position:"absolute",visibility:"hidden",display:"block"}).outerHeight(),n.css(s)}return a}i.component("nav",{defaults:{toggle:">li.@-parent > a[href='#']",lists:">li.@-parent > ul",multiple:!1},boot:function(){i.ready(function(t){i.$("[data-@-nav]",t).each(function(){var t=i.$(this);if(!t.data("nav")){i.nav(t,i.Utils.options(t.attr("data-@-nav")))}})})},init:function(){var t=this;this.on("click",this.options.toggle,function(n){n.preventDefault();var a=i.$(this);t.open(a.parent()[0]==t.element[0]?a:a.parent("li"))}),this.find(this.options.lists).each(function(){var n=i.$(this),a=n.parent(),s=a.hasClass("@-active");n.wrap('<div style="overflow:hidden;height:0;position:relative;"></div>'),a.data("list-container",n.parent()),s&&t.open(a,!0)})},open:function(t,a){var s=this.element,e=i.$(t);this.options.multiple||s.children(".@-open").not(t).each(function(){var t=i.$(this);t.data("list-container")&&t.data("list-container").stop().animate({height:0},function(){i.$(this).parent().removeClass("@-open")})}),e.toggleClass("@-open"),e.data("list-container")&&(a?e.data("list-container").stop().height(e.hasClass("@-open")?"auto":0):e.data("list-container").stop().animate({height:e.hasClass("@-open")?n(e.data("list-container").find("ul:first")):0}))}})}(jQuery,UIkit);